...
import "./BookVilla.scss";
import vila from '/vilas.png'
...
export default function BookVilla() {
  return (
    <div>
    <main>
    <h1>Book Villas/Chalets</h1>
    <div className="ability">
        <div className="info">
            <img src={vila} alt="" className="info__img"/>
            <h2 className="info__subtitle">Lux Trips gives you access to the most prestigious cars on the market.</h2>
            <p className="info__text">All the latest top-of-the-range models described by elegance, class and technology are among our wide range of rentals and hiring.</p>

<p className="info__subtext">Do you wish to feel like a Formula 1 driver and test the famous circuit in Monza? Or do you prefer to sit back and relax while our driver brings you across the most picturesque Amalfi coast? All you have to do is choose the destination and we will arrange the rest!</p>
<div className="blocks">
<div className="block">
    <img src={one} alt="" className="block__img"/>
    <p className="block__text">Dedicated 24/7 Travel Advisor</p>
</div>
<div className="block">
    <img src={two} alt="" className="block__img"/>
    <p className="block__text">Professional drivers and driver-coaches</p>
</div>
<div className="block">
    <img src={three} alt="" className="block__img"/>
    <p className="block__text">Wide selection of cars</p>
</div>
<div className="block">
    <img src={four} alt="" className="block__img"/>
    <p className="block__text">Accidental damage protection</p>
</div>
<div className="block">
    <img src={five} alt="" className="block__img"/>
    <p className="block__text">Dedicated health insurance</p>
</div>
<div className="block">
    <img src={six} alt="" className="block__img"/>
        ...
        <div className="form">
            <form action="">
                ...
                <option value="Border" />
                 ...
                 <div className="input">
                 <label for="party" className="input__label">Pick up time</label>
<input id="party" type="datetime-local" name="partydate" />
                ...
                <option value="Border" />
                 ...
                 <div className="input">
                 <label for="party" className="input__label">Drop off time</label>
<input id="party" type="datetime-local" name="partydate" />
                 </div>
                </div>
                <div className="loc">
